...
mydb=mysql.connector.connect(host='localhost',user='root',password='Indra@123',db='blogs')
with mysql.connector.connect(host='localhost',user='root',password='Indra@123',db='blogs'):
